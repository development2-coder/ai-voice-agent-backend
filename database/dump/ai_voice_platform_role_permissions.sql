...
CREATE TABLE `role_permissions` (
  ...
  UNIQUE KEY `uq_role_permissions_public_id` (`public_id`),
  KEY `ix_role_permissions_role` (`role_id`),
  KEY `ix_role_permissions_permission` (`permission_id`),
  KEY `ix_role_permissions_active` (`is_active`),
  KEY `ix_role_permissions_deleted` (`is_deleted`),
  KEY `idx_role_permissions_role` (`role_id`),
  KEY `idx_role_permissions_permission` (`permission_id`),
  KEY `idx_role_permissions_active` (`is_active`),
  KEY `idx_role_permissions_deleted` (`is_deleted`),
