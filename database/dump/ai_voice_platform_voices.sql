...
CREATE TABLE `voices` (
  ...
  `voice_code` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL,
  `voice_id` varchar(150) COLLATE utf8mb4_unicode_ci NOT NULL,
  `voice_name` varchar(150) COLLATE utf8mb4_unicode_ci NOT NULL,
  `agent_id` bigint NOT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `uk_voice_code` (`voice_code`),
  UNIQUE KEY `UKs4r1ebehgfxblonbhnwau8c5w` (`public_id`),
  KEY `FKea4eepwoq426ba6obrkhd47ri` (`agent_id`),
  CONSTRAINT `FKea4eepwoq426ba6obrkhd47ri` FOREIGN KEY (`agent_id`) REFERENCES `agents` (`id`)
